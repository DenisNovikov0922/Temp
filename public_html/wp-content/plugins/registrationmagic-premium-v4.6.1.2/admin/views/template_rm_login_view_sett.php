...
wp_localize_script('rm-login-form-presentation','pr_data',array('upload_btn_title'=>__('Choose Image','registrationmagic-gold'),'older_ie'=>__('You are using older version of IE. Please update IE to latest version','registrationmagic-gold'),'ajaxnonce' => wp_create_nonce('rm_form_settings_controller')));
...
<div class="rmagic" ng-controller="formStyleCtrl"  ng-app="formStyleApp">
    ...
    <div class="buttonarea popup-button-group" style="">
        <div class="cancel">
            ...
            <a value="&amp;#8592; &amp;nbsp; Cancel" href="?page=<?php echo $_GET['rdrto'] ?>" id="form_sett_post_sub-element-18">← &nbsp; <?php _e("Cancel", 'registrationmagic-gold') ?></a>
            <?php else: ?>
            <a value="&amp;#8592; &amp;nbsp; Cancel" href="?page=rm_login_sett_manage" id="form_sett_post_sub-element-18">← &nbsp; <?php _e("Cancel", 'registrationmagic-gold') ?></a>
            <?php endif; ?>
        </div> 

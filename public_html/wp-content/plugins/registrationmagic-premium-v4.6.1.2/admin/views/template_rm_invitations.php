    ...
    <div class="operationsbar">
        ...
        <ul>
            ...
            <li onclick="window.history.back()"><a href="javascript:void(0)"><?php echo RM_UI_Strings::get("LABEL_BACK"); ?></a></li>
               <li><a href="?page=rm_invitations_manage&rm_queues=true"><?php _e('Active Queues','registrationmagic-gold');  ?></a></li>
            <li><a href="?page=rm_sent_emails_manage"><?php _e('Sent Emails', 'registrationmagic-gold'); ?></a></li>
...
<?php
		...
		//$form->addElement(new Element_HTMLL('&#8592; &nbsp; '.__('Cancel','registrationmagic-gold'), '?page=rm_invitations_manage', array('class' => 'cancel')));

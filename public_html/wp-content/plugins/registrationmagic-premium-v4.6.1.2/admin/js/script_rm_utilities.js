...
function handle_review_banner_click(){
    var data = {
    ...
    window.open('https://wordpress.org/support/view/plugin-reviews/custom-registration-form-builder-with-submission-manager', '_blank');
}

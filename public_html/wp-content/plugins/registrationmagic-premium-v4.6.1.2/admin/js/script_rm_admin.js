...
//        RM_jQ("#scroll").hide();
        ...
        switch (field_type) {
            ...
            case 'WCBillingPhone' :
                var object = RM_jQ(".rm_field_value, .rm_textarea_type, .rm_options_type_fields, #rm_field_is_read_only-0, #rm_field_is_editable-0, #rm_field_max_length");
                break;
                
            case 'Privacy':
                var object = RM_jQ(".rm_field_value, .rm_textarea_type, .rm_options_type_fields, #rm_field_is_read_only-0, #rm_field_max_length, #rm_field_is_required-0, #rm_field_is_editable-0, #rm_sub_heading");
            ...
            case 'Hidden':
                var object = RM_jQ(".rm_field_value, .rm_textarea_type, .rm_options_type_fields, #rm_field_is_read_only-0, #rm_field_placeholder, #rm_field_helptext, #rm_field_class, #rm_field_max_length, #rm_field_is_required-0, #rm_field_is_editable-0").not("#rm_field_default_value");

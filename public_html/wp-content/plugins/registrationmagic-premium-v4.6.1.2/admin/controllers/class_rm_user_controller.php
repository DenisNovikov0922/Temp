...
class RM_USER_Controller
{
    ...
    public function view($model, RM_User_Services $service, $request, $params)
    {
        ...
        if (isset($request->req['user_id']))
        {
            ...
            //Prepare two array for tabs displayed on the User view page. These arrays can be customized by extensions to modify the tabs.
            //First array will contain tab titles another array will cotain html for the containts of that tab.
            //tabs in the arrays will be referenced with "refid" which will become "href" value for jQuery tabs.
            //The value of refid for standard tabs (provided by the core plugin) is rmfirsttabcontent, rmsecondtabcontent, rmthirdtabcontent respectively.
            //The content for these core tabs will be null, as it is generated in the template.

...
<div class="rm-logged-in-view">
    <div class="rm-logged-in-view-wrap">
        ...
        <div class="rm-logged-in-lf">
            <?php echo (!empty($view_options['display_user_avatar']))?(get_avatar($user->user_email)?get_avatar($user->user_email):'<img src="'.RM_IMG_URL.'default_person.png">'):'<img src="'.RM_IMG_URL.'default_person.png">' ?>
        </div>
        ...
        <div class="rm-logged-in-rf">
            ...
            <div class="rm-logged-welcome">
                ...
                <span class="rm-greetings-text"><?php echo empty($view_options['greetings_text']) ? __('Welcome','registrationmagic-gold') : $view_options['greetings_text']; ?></span>
                <?php endif; ?>
        ...
        <div class="rm-logged-in-account-links" style="border-color: #<?php echo $view_options['separator_bar_color']; ?>">
            ...
            <?php if(!empty($view_options['display_account_link'])): ?>
                    <div class="rm_display_account"><a href="<?php echo get_permalink($my_account); ?>"><?php echo empty($view_options['account_link_text']) ? __('My Account', 'registrationmagic-gold')  : $view_options['account_link_text']; ?></a></div>
            <?php endif; ?>

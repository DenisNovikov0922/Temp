...
foreach ($email_templates as $email) :
  ...
  if( $wpscfunction->check_ticket_conditions($conditions,$ticket_id) ) :
    ...
    $email_addresses = apply_filters('wpsc_en_ticket_feedback_email_addresses',$email_addresses,$email,$ticket_id);
   ...
   do_action('wpsc_after_feedback_notification_mail',$ticket_id,$args); 

...
<div id="order_xpay_details" class="panel">
    ...
    if (isset($aDetailsOrder['_scadenza_pan']) && $aDetailsOrder['_scadenza_pan'] != '') {
        ...
        ?>
              ...
              <strong>  <?php if (is_array($aInfoBO['report'][0]['dettaglio'][0]['stato'])&& count($aInfoBO['report'][0]['dettaglio'][0]['stato']) > 0) {
        ?>
    ...
    <?php if (is_array($aInfoBO['report'][0]['dettaglio'][0]['operazioni']) && count($aInfoBO['report'][0]['dettaglio'][0]['operazioni']) > 0) {
        ?>

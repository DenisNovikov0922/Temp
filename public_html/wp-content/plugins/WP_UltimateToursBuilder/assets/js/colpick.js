    ...
    var colpick = function () {
        var
                ...
                show = function (ev) {
                    ...
                    //  var options = $.extend({}, this.opt);
                        pos = $(this).position();
                        top = pos.top + this.offsetHeight;
                        if ($(this).closest('#wutb_bottomSettings').length > 0) {
                            left = $(this).offset().left - this.offsetWidth / 2;
                        } else {
                            left = pos.left
                        }
                    //  }
            ...
            init: function (opt) {
                ...
                return this.each(function () {
                    ...
                    if (!$(this).data('colpickId')) {
                        ...
                        //Setup submit button
                        cal.find('div.colpick_submit').html(options.submitText).on('click',clickSubmit);
                        //Setup input fields
                        options.fields = cal.find('input').change(change).blur(blur).focus(focus);
                        cal.find('div.colpick_field_arrs').mousedown(downIncrement).end().find('div.colpick_current_color').on('click',restoreOriginal);
                        //Setup hue selector
